...
public class Java extends Language
{
    ...
    int timeOut;
    int time;
    public Java(String path,String fileName,String extension,int time)
    {
        this.path=path;
      ...
      try 
        {
            ...
            String compileFileCommand="javac "+this.path+this.fileName+"."+this.extension;
    ...
    public void execute()
    {
        try 
        {
            ...
            out.write("cd \\ && cd "+this.path+" && java eg1 <inp.txt> out.txt");
            out.close();
